...
mixin _$ValueFailure<T> {
  T get invalidValue => throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function(T invalidValue) invalidEmail,
    required TResult Function(T invalidValue) shortPassword,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult Function(T invalidValue)? invalidEmail,
    TResult Function(T invalidValue)? shortPassword,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$InvalidEmail<T> implements InvalidEmail<T> {
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(invalidValue));
...
abstract class InvalidEmail<T> implements ValueFailure<T> {
  const factory InvalidEmail({required final T invalidValue}) =
      _$InvalidEmail<T>;
...
class _$ShortPassword<T> implements ShortPassword<T> {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return shortPassword?.call(invalidValue);
  }
...
abstract class ShortPassword<T> implements ValueFailure<T> {
  const factory ShortPassword({required final T invalidValue}) =
      _$ShortPassword<T>;
